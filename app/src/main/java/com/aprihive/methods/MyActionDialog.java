...
public class MyActionDialog {
    ...
    public MyActionDialog(Context context, String title, String msg, int image, Runnable action, String btnText, int btnColor){
        ...
        positiveBtn.setBackgroundColor(context.getResources().getColor(btnColor));
    ...
    //with icon color
    public MyActionDialog(Context context, String title, String msg, int image, int imageColor, Runnable action, String positiveBtnText, String negativeBtnText){
