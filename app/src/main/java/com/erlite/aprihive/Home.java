...
import com.erlite.aprihive.adapters.DiscoverRecyclerAdapter;
import com.erlite.aprihive.adapters.HomeViewPagerAdapter;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MyActionDialog dialog = new MyActionDialog(Home.this, "Sign Out?", "Are you sure you want to sign out?", R.drawable.ic_exit, action, "Yes, Sign out", "No, Just kidding.");
                dialog.show();
            }
        });
    ...
    private void sendNotification() {
        ...
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText("The ultimate network of student freelancers!\nPlease complete your profile to start networking."));
        ...
        registerQuery = reference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                try {
                    ...
                    if (isUserNew){
                        sendNotification();
                        MyActionDialog confirm = new MyActionDialog(Home.this, "Welcome to Aprihive!", "Welcome to the student freelance network.\nPlease click continue to finish setting up your account", R.drawable.vg_boy_skating, action, "Continue", R.color.color_theme_blue);
                        confirm.show();
                    }
